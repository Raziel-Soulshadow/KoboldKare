...
Shader "KoboldBasic"
{
	Properties
	{
		...
		[ASEEnd]_HueBrightnessContrastSaturation("_HueBrightnessContrastSaturation", Vector) = (0,0.5,0.5,0.5)
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _MaskMap;
			UNITY_INSTANCING_BUFFER_START(KoboldBasic)
			...
			UNITY_INSTANCING_BUFFER_END(KoboldBasic)


			float4 MyCustomExpression1_g31( float4 hsbc, float4 startColor )
			{
						 ...
						 ) : SV_Target
			{
				...
				float4 _HueBrightnessContrastSaturation_Instance = UNITY_ACCESS_INSTANCED_PROP(KoboldBasic,_HueBrightnessContrastSaturation);
				float4 hsbc1_g31 = _HueBrightnessContrastSaturation_Instance;
				float4 _BaseColorMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(KoboldBasic,_BaseColorMap_ST);
				float2 uv_BaseColorMap = IN.ase_texcoord8.xy * _BaseColorMap_ST_Instance.xy + _BaseColorMap_ST_Instance.zw;
				float4 startColor1_g31 = tex2D( _BaseColorMap, uv_BaseColorMap );
				float4 localMyCustomExpression1_g31 = MyCustomExpression1_g31( hsbc1_g31 , startColor1_g31 );
				...
				float4 lerpResult7_g30 = lerp( localMyCustomExpression1_g31 , tex2DNode3_g30 , saturate( ( tex2DNode3_g30.a * fresnelNode16_g30 ) ));
				
				float4 _NormalMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(KoboldBasic,_NormalMap_ST);
				float2 uv_NormalMap = IN.ase_texcoord8.xy * _NormalMap_ST_Instance.xy + _NormalMap_ST_Instance.zw;
				
				float4 _MaskMap_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(KoboldBasic,_MaskMap_ST);
				...
				float4 appendResult73 = (float4(tex2DNode16.r , tex2DNode16.g , tex2DNode16.b , tex2DNode16.a));
				...
				float3 Albedo = lerpResult7_g30.rgb;
				...
				#ifdef _CLEARCOAT
				float CoatMask = tex2DNode3_g30.a;
...
/*ASEBEGIN
Version=18935
208;485;1855;833;485.378;698.9658;1.517105;True;False
Node;AmplifyShaderEditor.SamplerNode;16;-544.4865,-190.4665;Inherit;True;Property;_MaskMap;MaskMap;3;0;Create;True;0;0;0;False;0;False;-1;None;ba658213c23f3f044964ac264d664e2a;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;99;730.9473,-426.799;Inherit;False;ApplyDecals;1;;30;d9b89e1202461fa45af2324780068fb2;0;3;4;COLOR;0,0,0,0;False;5;FLOAT3;0,0,0;False;6;COLOR;0,0,0,0;False;5;FLOAT;18;FLOAT;20;FLOAT3;14;FLOAT4;15;COLOR;13
...
Node;AmplifyShaderEditor.FunctionNode;18;-461.8067,-324.5077;Inherit;False;HueShift;-1;;31;1952e423258605d4aaa526c67ba2eb7c;0;2;2;FLOAT4;0,0.5,0.5,0.5;False;3;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.BreakToComponentsNode;75;1355.178,-75.60822;Inherit;False;FLOAT4;1;0;FLOAT4;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;61;2152.365,-171.9964;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;2;KoboldBasic;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;40;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;637993187703886279;  Transmission Shadow;1,False,-1;0;Translucency;0;637993187709786303;  Translucency Strength;1,False,-1;0;  Normal Distortion;1,False,-1;0;  Scattering;2,False,-1;0;  Direct;1,False,-1;0;  Ambient;0.2,False,-1;0;  Shadow;1,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;1;0;Receive Shadows;1;0;GPU Instancing;0;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;0;0;Debug Display;0;0;Clear Coat;1;637974989309817492;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=3B2209E9ADC51A00C8B5F5C734F4776610993910